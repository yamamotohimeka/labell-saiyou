...
class Auth
{
	...
	public static function register_driver_type($type, $check_method)
	{
		...
		{
			\Fuel\Core\Error::notice('Cannot add driver type, its name conflicts with another driver or method.');
			return false;
		}
	...
	public static function unregister_driver_type($type)
	{
		...
		{
			\Fuel\Core\Error::notice('Cannot remove driver type, included drivers login, group and acl cannot be removed.');
			return false;
		}
