...
<article>
    ...
    <section class="">
        <div class="container analyze_wrap date_info_col">
            ...
            <form class="analyze_info_inner" action="/analyze/emigrate" method="get">
                <h2 class="analyze_info_title">出稼ぎ</h2>
                <!--date_left_col-->
                <div class="analyze_form_wrap">
                    ...
                    <div class="analyze_btn">
                        <a href="/analyze/emigrate"><button type="submit" class="btn_orange" id="anl_btn" name="search" value="1">検索</button></a>
                    </div>
                </div>
            </form>
        </div>
