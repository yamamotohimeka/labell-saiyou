...
<article>
    ...
    <section>
        <form action="/master/form/belonging_store/{$id}" method="post" id="login" accept-charset="utf-8">
        <div class="container table_cmn">
            <h1 class="breadcrumb"><span>新規店舗の追加</span></h1>
            <div class="mstr_signup">
                <div class="mstr_signup_box">
                    <p>店舗名</p>
                    <input type="text" name="name" value="{$masterData.name|default:""}" size="68" class="signup_txt">
