...
<article>
    ...
    <section>
        <form action="/master/form/maildomain/{$id}" method="post" id="login" accept-charset="utf-8">
            <div class="container table_cmn">
                <h1 class="breadcrumb"><span>メールドメインの追加</span></h1>
                <div class="mstr_signup">
                    <div class="mstr_signup_box">
                        <p>メールドメイン名</p>
                        <input type="text" name="name" value="{$masterData.name|default:""}" size="68" class="signup_txt domain">
