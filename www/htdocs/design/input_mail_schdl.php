...
<section class="container send_mail_col">
	...
	<form class="send_mail_wrap">
		...
		<textarea name="" rows="30" cols="95" class="send_mail_contents" placeholder="面接予定送信メールの内容が入ります"></textarea>
	</form>
	<div class="send_col_wrap">
		<div class="info_return inline mail_button">
	      <a href="input_send_schdl.php"><button type="button">前のページに戻る <i class="fa fa-undo"></i></button></a>
	    </div>	
	    <div class="info_send inline mail_button">
	      <a href="input_sent_schdl.php"><button type="button">メール送信</button></a>
	    </div>
    </div>
  </div>
</section>
