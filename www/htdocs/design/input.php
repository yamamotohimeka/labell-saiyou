    ...
    <div class="date_info_inner">
      ...
      <div class="date_right_col">
        ...
        <div class="white_box input_right SSmall">
          <p>掲載媒体</p>
          <div id="baitai" class="select_arrow">
            <select name="掲載媒体">
              <option value="0">—</option>
              <option value="1">Qプリ</option>
              <option value="2">ガールズヘブン</option>
              <option value="3">ぴゅあじょ</option>
              <option value="4">１５なび</option>
              <option value="5">バニラ</option>
              <option value="6">出稼ぎ.com</option>
            </select>
          </div>
        </div>
        <!-- 掲載エリア-->
        <div class="white_box input_right SSmall">
          <p>掲載エリア</p>
          <div id="keiarea" class="select_arrow">
            <select name="掲載エリア">
              <option value="0">—</option>
        ...
        <div class="white_box input_right SSSmall">
          <p>掲載求人</p>
          <div id="keikyu" class="select_arrow">
            <select name="掲載求人">
              <option value="0">—</option>
        ...
        <div class="white_box input_right SSmall">
          <p>掲載業種</p>
          <div id="keigyo" class="select_arrow">
            <select name="掲載業種">
              <option value="0">—</option>
        ...
        <!--チェック-->
          <div class="white_box input_check">
            <div class="checkbox">
              <label>
        ...
        <div class="white_box input_right XSmall clear">
          <p>スカウト</p>
          <div id="scout" class="select_arrow select_scout">
            <select name="スカウト">
              <option value="">—</option>
              <?php for ($i=1; $i <= 100; $i++) : ?>
              <option value="<?php echo $i;?>"><?php echo $i; ?></option>
        ...
        <div class="white_box input_right">
          <p>出戻り・移籍・紹介</p>
          <div id="demodori" class="select_arrow">
        ...
        <div class="white_box input_check clear">
          ...
          <div class="checkbox">
            ...
            <div class="select_arrow">
              <select id="select_id" name="身分証希望" style="width:150px;">
                <optgroup label="全て選択">
            ...
            <input type="text" name="身分証メモ" value="" size="12">
            ...
            <label>
              <input type="checkbox" name="checkbox[]" class="checkbox-sqar">
              <span class="checkbox-txt text_right">事前確認なし</span>
            </label><br>
            <label>
              <input type="checkbox" name="checkbox[]" class="checkbox-sqar">
            ...
            <input type="text" name="その他" value="" size="60">
            <span class="select_other_txt">　</span>
            <label>
              <input type="checkbox" name="checkbox[]" class="checkbox-sqar">
            ...
            <input type="text" pattern="^¥d+$" title="半角数字でご入力ください。" name="出稼ぎ日数" value="" size="4">
            <span class="select_other_txt">日</span><br>
             <p class="description">ニコイチは面接予定情報で★マークがつく</p>
          </div>
          <p class="memo_ttl">メモ</p>
...
$(function(){
  ...
  //選択(媒体・スカウト・出戻り)
    $(function() {
       var scout = $('#scout option'),
           demodori = $('#demodori option'),
           baitai = $('#baitai option'),
           keiarea = $('#keiarea option'),
           keikyu = $('#keikyu option'),
           keigyo = $('#keigyo option');

      $('#baitai select').change(function(){
      　　var selectArea = $(this).val();
        if (selectArea == 0) {
            scout.removeAttr("disabled");
            demodori.removeAttr("disabled");
        } else {
            scout.attr("disabled","disabled");
            demodori.attr("disabled","disabled");
        }
      });

      $('#scout select').change(function(){
      　　var selectScout = $(this).val();
        if (selectScout == 0) {
            baitai.removeAttr("disabled");
            demodori.removeAttr("disabled");
            keiarea.removeAttr("disabled");
            keikyu.removeAttr("disabled");
            keigyo.removeAttr("disabled");
        } else {
            baitai.attr("disabled","disabled");
            demodori.attr("disabled","disabled");
            keiarea.attr("disabled","disabled");
            keikyu.attr("disabled","disabled");
            keigyo.attr("disabled","disabled");
            $('#keiarea select ,#keikyu select  ,#keigyo select').val(0);
        }
      });
      $('#demodori select').change(function(){
      　　var selectDemodori = $(this).val();
        if (selectDemodori == 0) {
            baitai.removeAttr("disabled");
            scout.removeAttr("disabled");
            keiarea.removeAttr("disabled");
