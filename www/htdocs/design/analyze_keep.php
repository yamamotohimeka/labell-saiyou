...
<section class="">
  <div class="container analyze_wrap date_info_col">
    ...
    <!-- date_info_inner-->
    <form class="analyze_info_inner" action="analyze_keep_result.php" method="get">
      <h2>継続率</h2>
      <!--date_left_col-->
      <div class="analyze_form_wrap">
        ...
        <div class="clear analyze_alert">
          <span>継続率＝(入店数-退店数)÷入店数×100<br>入店数は採用情報に上がっている中で面接結果が「採用」のデータをカウント</span>
        </div>
        <!--検索ボタン-->
        <div class="analyze_btn">
          <a href="analyze_keep_result.php"><button type="submit" class="btn_orange" id="anl_btn">検索</button></a>
        </div>
      </div>
    </form>
  </div>
