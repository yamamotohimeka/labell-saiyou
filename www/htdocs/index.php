...
}elseif($_SERVER["REMOTE_ADDR"] == "113.197.142.105") { // TODO NAGAMORI 開発環境
    error_reporting(-1);
    ini_set('display_errors', 1);
}elseif($_SERVER["REMOTE_ADDR"] == "172.19.0.1" || $_SERVER["REMOTE_ADDR"] == "127.0.0.1" || $_SERVER["REMOTE_ADDR"] == "::1") { // Docker / local
    error_reporting(-1);
    ini_set('display_errors', 1);
}else{
    error_reporting(0);
